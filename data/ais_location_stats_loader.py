...
해구·시간대별 신고 척수 통계, crowding_pressure_raw 보완용.

원본 EUC-KR(CP949), UTF-8로 읽으면 깨짐.

컬럼: 해구번호/일자/일시(0~23시)/척수/좌상단·우하단 경계좌표
(경계 결측 0.6%). 기간 2019-10-01~2020-03-31 (파일명 날짜는 발행일).
"""
