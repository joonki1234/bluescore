...
VESSEL_SEEDS = [
    {
        ...
        # 격자 (6,4) = gx 240–279 · gy 160–199 를 세 번 나눠 찾아온다
        # (idx 3·4 → 9 → 12). 아래 revisitCount 3과 항적이 같은 말을 하도록 짠 것이다.
        "track": [
            [70, 300], [120, 265], [180, 225], [250, 175], [268, 192], [320, 150],
            [355, 118], [300, 145], [285, 205], [262, 178], [205, 135], [230, 158],
            [255, 185],
        ],
        "fishingSegments": [[3, 4], [6, 6], [9, 9], [12, 12]],
        "gapIndex": 8,
        "mpaIndex": 6,
    },
    {
        ...
        # 격자 (5,4) = gx 200–239 · gy 160–199 를 네 번 찾아온다
        # (idx 2·3 → 6 → 8 → 10). A축 점수가 낮은 선박이라 재방문이 잦다.
        "track": [
            [60, 90], [120, 130], [215, 175], [230, 190], [300, 240], [270, 215],
            [225, 168], [320, 265], [205, 182], [150, 240], [235, 195], [180, 250],
        ],
        "fishingSegments": [[1, 3], [6, 6], [8, 8], [10, 10]],
        "gapIndex": -1,
        "mpaIndex": -1,
    },
    {
        ...
        # 격자 (7,2) = gx 280–319 · gy 80–119 만 두 번(idx 5 → 10) 찾아온다.
        # A축 점수가 가장 높은 선박이라 재방문이 드물고 간격도 넓다.
        "track": [
            [80, 60], [120, 90], [175, 85], [215, 105], [250, 95], [295, 110],
            [345, 100], [370, 140], [340, 175], [300, 195], [290, 115], [225, 205],
        ],
