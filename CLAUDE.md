...
12. **(10번 재론·교체) 매칭을 로마자 유사도(0.8 임계값)에서 한글
    ...
    (1,234→713척, 13.4%, PROCESS_LOG.md 53번). 이어서 verified 25쌍
    스팟체크로 "NO.6 KYUNG YANG"이 IMO번호·601GT 원양 참치연승선인데
    TAC의 8.55톤 근해소형선과 오매칭된 걸 발견 — GFW `registryInfo`
    있는 선박(21척, 0.4%)을 후보풀에서 통째로 제외함(713→712척,
    PROCESS_LOG.md 54번) — **지금 이 수치(712척, 13.4%)가 최종.**
